...
from .views import asset, edit_asset, delete_asset, merchant, index, merchant_edit, merchant_delete, asset_in, asset_details
from . import views
...
urlpatterns = [
    ...
    url(r'details_asset', asset_details, name='AssetManagementDetailsForms'),
]
